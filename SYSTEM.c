...
__TDESC(SYSTEM_ModuleDesc, 1, 2) = {__TDFLDS("ModuleDesc", 80), {0, 40, -24}};
__TDESC(SYSTEM_CmdDesc, 1, 1) = {__TDFLDS("CmdDesc", 40), {0, -16}};
__TDESC(SYSTEM_FinDesc, 1, 1) = {__TDFLDS("FinDesc", 32), {0, -16}};
__TDESC(SYSTEM__1, 1, 1) = {__TDFLDS("", 16), {8, -16}};
